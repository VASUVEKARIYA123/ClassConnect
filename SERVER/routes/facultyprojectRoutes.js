...
// Routes
router.get("/:classroomId/:facultyId", auth, authorizeRole(["admin","subadmin","teacher","student"]),facultyProjectController.getFacultyProjects);
...
router.get("/:facultyProjectId", auth, authorizeRole(["admin","subadmin","teacher","student"]), facultyProjectController.getFacultyProjectById);
